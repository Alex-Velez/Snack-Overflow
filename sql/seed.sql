...
INSERT IGNORE INTO items (sku, upc, item_name, item_desc, price, rating, category, img_path) VALUES
...
(64710, 093000012345, 'Whole Cauliflower', 'Nutritious and Delicious', 2.79, 4.9, 'vegetable', '/uploads/items/cauliflower.png'),
...
(35068, 345678901234, 'Whole Corn Cob', 'One full Cob', 0.75, 4.6, 'vegetable', '/uploads/items/corn.png'),
...
(79053, 678901234567, 'Whole Onion', 'One Complete Onion', 0.59, 4.3, 'vegetable', '/uploads/items/onion.png'),
...
(85360, 098765432109, 'Whole Potato', 'One single Potato', 0.69, 3.8, 'vegetable', '/uploads/items/potato.png'),
...
(71820, 444444444441, 'Loaf of White Bread', 'A sliced loaf of bread', 1.99, 4.0, 'bread', '/uploads/items/white_bread.png'),
(29573, 555555555556, 'Loaf of Whole Grain Bread', 'Healthy loaf of sliced bread', 2.49, 3.7, 'bread', '/uploads/items/whole_grain_bread.png'),
(86149, 666666666661, 'Cup of Peach Yogurt', '12oz cup of Yogurt', 0.89, 4.3, 'dairy', '/uploads/items/yogurt.png')
